...
import {searchFlickr, getDims, getUrl} from '../lib/flickr.js';
import '../lib/lazy-image.js';

export {searchFlickr, getDims, getUrl};
    ...
    _setUp() {
        this.list = Object.assign(new VirtualList(), {
            ...
            newChildFn: () => {
                ...
                h.style = "color: white; position: absolute; bottom: 0; width: 100%; marign: 0; padding: 0 1em; box-sizing: border-box; text-align: center; font-family: sans-serif; text-shadow: rgba(0, 0, 0, 0.5) 2px 2px;";
                img.appendChild(h);
                return img;
            },
